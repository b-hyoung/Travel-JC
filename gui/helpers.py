...
LANG_INFO = {
    "한국어": {
        ...
        "open": "열기",
        "course_reco": "코스 추천",
        "tour_food_reco": "관광지/음식 추천",
        "chat_title": "대화형",
        "chat_placeholder": "질문을 입력하세요.",
        "chat_send": "보내기",
        "chat_mic": "말하기",
        "chat_status_listening": "듣는 중...",
        "chat_status_processing": "처리 중...",
        "chat_status_thinking": "생각하는 중...",
        "chat_status_error": "처리 중 오류가 발생했습니다.",
        "chat_error_no_mic": "마이크를 사용할 수 없습니다.",
        "chat_error_no_key": "API 키가 설정되지 않았습니다.",
        "chat_error_no_speech": "음성을 인식하지 못했습니다.",
        "chat_weather_missing": "날씨 정보를 불러오지 못했습니다.",
        "chat_course_missing": "코스 정보를 찾을 수 없습니다.",
        "chat_course_list": "추천 코스:",
        "chat_food_none": "추천할 음식이 없습니다.",
        "chat_food_spicy": "매운 메뉴 추천:",
        "chat_food_reco": "음식 추천:",
        "chat_tour_none": "추천할 관광지가 없습니다.",
        "chat_tour_reco": "관광지 추천:",
        "chat_help": "원하시는 내용을 말씀해 주세요. 예: 매운 음식, 코스 추천",
    ...
    "English": {
        ...
        "qr": "QR",
        "open": "Open",
        "course_reco": "Course Recommendations",
        "tour_food_reco": "Tour/Food Recommendations",
        "chat_title": "Chat",
        ...
        "chat_status_error": "Something went wrong.",
        "chat_error_no_mic": "Microphone is unavailable.",
        "chat_error_no_key": "API key is missing.",
        "chat_error_no_speech": "No speech detected.",
        "chat_weather_missing": "Weather data is not ready yet.",
        "chat_course_missing": "No course data available.",
        "chat_course_list": "Top courses:",
        "chat_food_none": "No menus available.",
        "chat_food_spicy": "Spicy menu picks:",
        "chat_food_reco": "Food picks:",
        "chat_tour_none": "No attractions available.",
        "chat_tour_reco": "Attraction picks:",
        "chat_help": "Tell me what you want, like spicy food or a course recommendation.",
